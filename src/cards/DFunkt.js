        ...
        <div>
          ...
          <div className="users">
            { this.props.data.mandates.map((x) => (
              <div key={'mandate-pic-' + x.user.kthid + '-' + x.role.identifier + '-' + this.props.data.date} className="crop" style={{backgroundImage: 'url(https://zfinger.datasektionen.se/user/' + x.user.kthid + '/image/200)'}} />
            )) }
          </div>
          ) : false }
