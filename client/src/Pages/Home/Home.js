        ...
        <div className="Home">
            ...
            <div className="Body">
                ...
                <div className="row">
                    <div className="col">
                        <h2>Om</h2>
                        Systemet började byggas av Jonas Dahl i början av 2018 men lades sedan på is i lite mer än två år innan någon byggde vidare. Axel Elmarsson fortsatte utvecklingen av systemet, som blev färdigt i början av 2021.
                    </div>
                    <div className="col">
                        <h2>Hjälp</h2>
